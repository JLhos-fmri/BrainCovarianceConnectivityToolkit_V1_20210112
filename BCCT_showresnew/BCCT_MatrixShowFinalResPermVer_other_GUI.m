function BCCT_MatrixShowFinalResPermVer_other_GUI(Pval,outdir,enhanind,Coltype,PVALT,Pvalused,orders)
[mpat,mnam,mext] = fileparts(which('BCCT_MatrixShowFinalResPermVer_bat_GUI.m'));
...
% ZPvalShowTEMP(Pval>0.5) = 1-ZPval((Pval>0.5));
