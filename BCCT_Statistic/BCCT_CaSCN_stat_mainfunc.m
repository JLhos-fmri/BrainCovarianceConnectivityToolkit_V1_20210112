    ...
    if Parameter.Permlab==1
        ...
        for i = 1:size(ROIsig_g1,2)    
            ...
            if RealComp1.RealCompPara.Calmethod1 % res
                if i<10
                    Outfilenametemp1 = fullfile(Outputdir,['PermP_x2y_ROI00000',num2str(i),'.nii']);
                    Outfilenametemp2 = fullfile(Outputdir,['PermP_y2x_ROI00000',num2str(i),'.nii']);
                    Outfilenametemp3 = fullfile(Outputdir,['PermP_x2ytrans_ROI00000',num2str(i),'.nii']);
                    Outfilenametemp4 = fullfile(Outputdir,['PermP_y2xtrans_ROI00000',num2str(i),'.nii']);
                    Outfilenametemp5 = fullfile(Outputdir,['PermP_Netx2y_ROI00000',num2str(i),'.nii']);
                elseif i<100
                    Outfilenametemp1 = fullfile(Outputdir,['PermP_x2y_ROI0000',num2str(i),'.nii']);
                    Outfilenametemp2 = fullfile(Outputdir,['PermP_y2x_ROI0000',num2str(i),'.nii']);
                    Outfilenametemp3 = fullfile(Outputdir,['PermP_x2ytrans_ROI0000',num2str(i),'.nii']);
                    Outfilenametemp4 = fullfile(Outputdir,['PermP_y2xtrans_ROI0000',num2str(i),'.nii']);
                    Outfilenametemp5 = fullfile(Outputdir,['PermP_Netx2y_ROI0000',num2str(i),'.nii']);
                elseif i<1000
                    Outfilenametemp1 = fullfile(Outputdir,['PermP_x2y_ROI000',num2str(i),'.nii']);
                    Outfilenametemp2 = fullfile(Outputdir,['PermP_y2x_ROI000',num2str(i),'.nii']);
                    Outfilenametemp3 = fullfile(Outputdir,['PermP_x2ytrans_ROI000',num2str(i),'.nii']);
                    Outfilenametemp4 = fullfile(Outputdir,['PermP_y2xtrans_ROI000',num2str(i),'.nii']);
                    Outfilenametemp5 = fullfile(Outputdir,['PermP_Netx2y_ROI000',num2str(i),'.nii']);
                else
                    Outfilenametemp1 = fullfile(Outputdir,['PermP_x2y_ROI0',num2str(i),'.nii']);
                    Outfilenametemp2 = fullfile(Outputdir,['PermP_y2x_ROI0',num2str(i),'.nii']);
                    Outfilenametemp3 = fullfile(Outputdir,['PermP_x2ytrans_ROI0',num2str(i),'.nii']);
                    Outfilenametemp4 = fullfile(Outputdir,['PermP_y2xtrans_ROI0',num2str(i),'.nii']);
                    Outfilenametemp5 = fullfile(Outputdir,['PermP_Netx2y_ROI0',num2str(i),'.nii']);
                end
                ...
                for i_ord = 1:RealComp1.RealCompPara.GCAorder
                    if i<10
                        Outfilenametemp1 = fullfile(Outputdir,['PermP_x2y_ROI00000',num2str(i),'_Order_',num2str(i_ord),'.nii']);
                        Outfilenametemp2 = fullfile(Outputdir,['PermP_y2x_ROI00000',num2str(i),'_Order_',num2str(i_ord),'.nii']);
                    elseif i<100
                        Outfilenametemp1 = fullfile(Outputdir,['PermP_x2y_ROI0000',num2str(i),'_Order_',num2str(i_ord),'.nii']);
                        Outfilenametemp2 = fullfile(Outputdir,['PermP_y2x_ROI0000',num2str(i),'_Order_',num2str(i_ord),'.nii']);
                    elseif i<1000
                        Outfilenametemp1 = fullfile(Outputdir,['PermP_x2y_ROI000',num2str(i),'_Order_',num2str(i_ord),'.nii']);
                        Outfilenametemp2 = fullfile(Outputdir,['PermP_y2x_ROI000',num2str(i),'_Order_',num2str(i_ord),'.nii']);
                    else
                        Outfilenametemp1 = fullfile(Outputdir,['PermP_x2y_ROI0',num2str(i),'_Order_',num2str(i_ord),'.nii']);
                        Outfilenametemp2 = fullfile(Outputdir,['PermP_y2x_ROI0',num2str(i),'_Order_',num2str(i_ord),'.nii']);
                    end
                    for iperm = 1:Permnum
...
elseif strcmp(RealComp1.RealCompPara.mod,'surfmap')
    ...
    if Parameter.Permlab==1
        ...
        for i = 1:size(ROIsig_g1,2)    
            ...
            if RealComp1.RealCompPara.Calmethod1 % res
                if i<10
                    Outfilenametemp1_L = fullfile(Outputdir,['lh.PermP_x2y_ROI00000',num2str(i),'.mgh']);
                    Outfilenametemp2_L = fullfile(Outputdir,['lh.PermP_y2x_ROI00000',num2str(i),'.mgh']);
                    Outfilenametemp3_L = fullfile(Outputdir,['lh.PermP_x2ytrans_ROI00000',num2str(i),'.mgh']);
                    Outfilenametemp4_L = fullfile(Outputdir,['lh.PermP_y2xtrans_ROI00000',num2str(i),'.mgh']);
                    Outfilenametemp5_L = fullfile(Outputdir,['lh.PermP_Netx2y_ROI00000',num2str(i),'.mgh']);
                    OutfilenametempMat = fullfile(Outputdir,['PermP_ROI00000',num2str(i),'.mat']);
                    
                    Outfilenametemp1_R = fullfile(Outputdir,['rh.PermP_x2y_ROI00000',num2str(i),'.mgh']);
                    Outfilenametemp2_R = fullfile(Outputdir,['rh.PermP_y2x_ROI00000',num2str(i),'.mgh']);
                    Outfilenametemp3_R = fullfile(Outputdir,['rh.PermP_x2ytrans_ROI00000',num2str(i),'.mgh']);
                    Outfilenametemp4_R = fullfile(Outputdir,['rh.PermP_y2xtrans_ROI00000',num2str(i),'.mgh']);
                    Outfilenametemp5_R = fullfile(Outputdir,['rh.PermP_Netx2y_ROI00000',num2str(i),'.mgh']);
                elseif i<100
                    Outfilenametemp1_L = fullfile(Outputdir,['lh.PermP_x2y_ROI0000',num2str(i),'.mgh']);
                    Outfilenametemp2_L = fullfile(Outputdir,['lh.PermP_y2x_ROI0000',num2str(i),'.mgh']);
                    Outfilenametemp3_L = fullfile(Outputdir,['lh.PermP_x2ytrans_ROI0000',num2str(i),'.mgh']);
                    Outfilenametemp4_L = fullfile(Outputdir,['lh.PermP_y2xtrans_ROI0000',num2str(i),'.mgh']);
                    Outfilenametemp5_L = fullfile(Outputdir,['lh.PermP_Netx2y_ROI0000',num2str(i),'.mgh']);
                    OutfilenametempMat = fullfile(Outputdir,['PermP_ROI000',num2str(i),'.mat']);
                    
                    Outfilenametemp1_R = fullfile(Outputdir,['rh.PermP_x2y_ROI0000',num2str(i),'.mgh']);
                    Outfilenametemp2_R = fullfile(Outputdir,['rh.PermP_y2x_ROI0000',num2str(i),'.mgh']);
                    Outfilenametemp3_R = fullfile(Outputdir,['rh.PermP_x2ytrans_ROI0000',num2str(i),'.mgh']);
                    Outfilenametemp4_R = fullfile(Outputdir,['rh.PermP_y2xtrans_ROI0000',num2str(i),'.mgh']);
                    Outfilenametemp5_R = fullfile(Outputdir,['rh.PermP_Netx2y_ROI0000',num2str(i),'.mgh']);
                elseif i<1000
                    Outfilenametemp1_L = fullfile(Outputdir,['lh.PermP_x2y_ROI000',num2str(i),'.mgh']);
                    Outfilenametemp2_L = fullfile(Outputdir,['lh.PermP_y2x_ROI000',num2str(i),'.mgh']);
                    Outfilenametemp3_L = fullfile(Outputdir,['lh.PermP_x2ytrans_ROI000',num2str(i),'.mgh']);
                    Outfilenametemp4_L = fullfile(Outputdir,['lh.PermP_y2xtrans_ROI000',num2str(i),'.mgh']);
                    Outfilenametemp5_L = fullfile(Outputdir,['lh.PermP_Netx2y_ROI000',num2str(i),'.mgh']);
                    OutfilenametempMat = fullfile(Outputdir,['PermP_ROI000',num2str(i),'.mat']);
                    
                    Outfilenametemp1_R = fullfile(Outputdir,['rh.PermP_x2y_ROI000',num2str(i),'.mgh']);
                    Outfilenametemp2_R = fullfile(Outputdir,['rh.PermP_y2x_ROI000',num2str(i),'.mgh']);
                    Outfilenametemp3_R = fullfile(Outputdir,['rh.PermP_x2ytrans_ROI000',num2str(i),'.mgh']);
                    Outfilenametemp4_R = fullfile(Outputdir,['rh.PermP_y2xtrans_ROI000',num2str(i),'.mgh']);
                    Outfilenametemp5_R = fullfile(Outputdir,['rh.PermP_Netx2y_ROI000',num2str(i),'.mgh']);
                else
                    Outfilenametemp1_L = fullfile(Outputdir,['lh.PermP_x2y_ROI00',num2str(i),'.mgh']);
                    Outfilenametemp2_L = fullfile(Outputdir,['lh.PermP_y2x_ROI00',num2str(i),'.mgh']);
                    Outfilenametemp3_L = fullfile(Outputdir,['lh.PermP_x2ytrans_ROI00',num2str(i),'.mgh']);
                    Outfilenametemp4_L = fullfile(Outputdir,['lh.PermP_y2xtrans_ROI00',num2str(i),'.mgh']);
                    Outfilenametemp5_L = fullfile(Outputdir,['lh.PermP_Netx2y_ROI00',num2str(i),'.mgh']);
                    OutfilenametempMat = fullfile(Outputdir,['PermP_ROI00',num2str(i),'.mat']);
                    
                    Outfilenametemp1_R = fullfile(Outputdir,['rh.PermP_x2y_ROI00',num2str(i),'.mgh']);
                    Outfilenametemp2_R = fullfile(Outputdir,['rh.PermP_y2x_ROI00',num2str(i),'.mgh']);
                    Outfilenametemp3_R = fullfile(Outputdir,['rh.PermP_x2ytrans_ROI00',num2str(i),'.mgh']);
                    Outfilenametemp4_R = fullfile(Outputdir,['rh.PermP_y2xtrans_ROI00',num2str(i),'.mgh']);
                    Outfilenametemp5_R = fullfile(Outputdir,['rh.PermP_Netx2y_ROI00',num2str(i),'.mgh']);
                end
...
%                 SurfStatWriteData(Outfilenametemp5,DAT)
                ...
                for i_ord = 1:RealComp1.RealCompPara.GCAorder
                    if i<10
                        Outfilenametemp1_L = fullfile(Outputdir,['lh.PermP_x2y_ROI00000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametemp2_L = fullfile(Outputdir,['lh.PermP_y2x_ROI00000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametempmat = fullfile(Outputdir,['PermP_ROI00000',num2str(i),'_Order_',num2str(i_ord),'.mat']);
                        Outfilenametemp1_R = fullfile(Outputdir,['rh.PermP_x2y_ROI00000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametemp2_R = fullfile(Outputdir,['rh.PermP_y2x_ROI00000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                    elseif i<100
                        Outfilenametemp1_L = fullfile(Outputdir,['lh.PermP_x2y_ROI0000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametemp2_L = fullfile(Outputdir,['lh.PermP_y2x_ROI0000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametempmat = fullfile(Outputdir,['PermP_ROI0000',num2str(i),'_Order_',num2str(i_ord),'.mat']);
                        Outfilenametemp1_R = fullfile(Outputdir,['rh.PermP_x2y_ROI0000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametemp2_R = fullfile(Outputdir,['rh.PermP_y2x_ROI0000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                    elseif i<1000
                        Outfilenametemp1_L = fullfile(Outputdir,['lh.PermP_x2y_ROI000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametemp2_L = fullfile(Outputdir,['lh.PermP_y2x_ROI000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametempmat = fullfile(Outputdir,['PermP_ROI000',num2str(i),'_Order_',num2str(i_ord),'.mat']);
                        Outfilenametemp1_R = fullfile(Outputdir,['rh.PermP_x2y_ROI000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametemp2_R = fullfile(Outputdir,['rh.PermP_y2x_ROI000',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                    else
                        Outfilenametemp1_L = fullfile(Outputdir,['lh.PermP_x2y_ROI00',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametemp2_L = fullfile(Outputdir,['lh.PermP_y2x_ROI00',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametempmat = fullfile(Outputdir,['PermP_ROI00',num2str(i),'_Order_',num2str(i_ord),'.mat']);
                        Outfilenametemp1_R = fullfile(Outputdir,['rh.PermP_x2y_ROI00',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                        Outfilenametemp2_R = fullfile(Outputdir,['rh.PermP_y2x_ROI00',num2str(i),'_Order_',num2str(i_ord),'.mgh']);
                    end
                    for iperm = 1:Permnum
                        G1_Map1temp(iperm,:) = Res1(iperm).coef.ResultMap1{i_ord};
                        G1_Map2temp(iperm,:) = Res1(iperm).coef.ResultMap2{i_ord};
